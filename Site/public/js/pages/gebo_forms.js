...
gebo_progressbars = {
  init: function () {
    var iEnd1 = new Date().setTime(new Date().getTime() + 25 * 1000);
    ...
    var iNow = new Date().setTime(new Date().getTime() + 2 * 1000);
    var iEnd2 = new Date().setTime(new Date().getTime() + 10 * 1000);
    ...
    var iEnd3 = new Date().setTime(new Date().getTime() + 15 * 1000);
...
gebo_pass_check = {
  init: function () {
    $('#pass_check').complexify({
      ...
      if (!valid) {
        $('#pass_progress').children('.progress-bar').css({
          'width': complexity + '%'
