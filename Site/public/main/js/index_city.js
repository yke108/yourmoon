...
var region_city=document.getElementById('city')?document.getElementById('city'):$("<select id='city'></select>")[0];
var region_district=document.getElementById('district')?document.getElementById('district'):$("<select id='district'></select>")[0];
