(function($){
	$.fn.yomi=function(){
		...
		createdom =function(dom){
			_DOM=dom;
			data=$(dom).attr("data");
			title=$(dom).attr('title')==undefined?'仅剩':$(dom).attr('title');
			data = data.replace(/-/g,"/");
			data = Math.round((new Date(data)).getTime()/1000);
			$(_DOM).append(title+"：<em class='yomiday'></em><em class='split'>天</em><em class='yomihour'></em><em class='split'>时</em><em class='yomimin'></em><em class='split'>分</em><em class='yomisec'></em><em class='split'>秒</em>")
			reflash();
		};
		reflash=function(){
