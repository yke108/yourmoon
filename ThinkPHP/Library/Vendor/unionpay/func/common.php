...
//include_once $_SERVER ['DOCUMENT_ROOT'] . '/func/log.class.php';
//include_once $_SERVER ['DOCUMENT_ROOT'] . '/func/SDKConfig.php';


include_once VENDOR_PATH.'unionpay/func/SDKConfig.php';
include_once VENDOR_PATH.'unionpay/func/log.class.php';
